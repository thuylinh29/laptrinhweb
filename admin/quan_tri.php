...
<body>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <nav class="header__menu mobile-menu">
                        <ul>
                            <li class="active"><a href="quan_tri.php">Quản trị</a></li>
    ...
    <!-- Header Section End -->
     ...
     <section class="login spad">
         <div class="container">
            <div class="row">
                <div class="contact__text" style="margin-left: 250px;">
                    <h3>Chào mừng bạn <?php echo $_SESSION["taikhoan"] ?> đến với trang quản trị cửa hàng! </h3>
                    <a href="doi_mat_khau.php?id_admin=<?php echo $row["id_admin"] ;?>" style="margin-left: 300px;">Đổi mật khẩu</a>
                </div>
            </div>
        </div>
    </section>

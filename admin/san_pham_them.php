...
<body>
    ...
    <!-- Header Section End -->
     ...
     <section class="login spad">
        <div class="row">
                <div >
                    <p style="font-style: italic; font-weight: bold; font-family: Playfair Display; font-size: 20px; margin-top:-50px; margin-left: 50px;">Thêm sản phẩm: </p>
                </div>
                <div>
                    <form method="POST" action="./san_pham_them_thuc_hien.php" enctype="multipart/form-data">
                        <div class="row">
                            <div>
                                <p>
                                    Tên sản phẩm:<br>
                                    <input type="text" name="txtTenSP" style="width: 100%">
                                </p>
                                <p>
                                    Tên loại sản phẩm: <br>
                                    <select name="txtLoaiSP" id="" multiple="multiple">
                            ...
                            <div style="margin-left: 50px;">
                                <p>
                                    Mô tả: <br>
                                    <textarea name="txtMoTa" style="width: 200%;"></textarea>
                                </p>
                                <p>
                                    Giá bán: <br>
                                ...
                                <p>
                                    Số lượng tồn kho:<br>
                                    <input type="text" name="txtSLTonKho" style="width: 100%">
                                </p>

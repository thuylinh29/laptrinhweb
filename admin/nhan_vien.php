...
<body>
                ...
                <div class="col-lg-12">
                    <nav class="header__menu mobile-menu">
                        <ul>
                            ...
                            <li  class="active"><a href="nhan_vien.php">Nhân viên</a></li>
    ...
    <!-- Header Section End -->
     ...
     <section class="login spad">
        <div class="row">
                <div >
                    <p style="font-style: italic; font-weight: bold; font-family: Playfair Display; font-size: 20px; margin-top:-50px; margin-left: 50px;">Thông tin khách hàng: </p>
                        <?php 
                            $ket_noi=mysqli_connect("localhost","root","","cua_hang_banh");
                            $count="SELECT * from tbl_nhan_vien";
                            $query=mysqli_query($ket_noi,$count);
                            $dem=mysqli_num_rows($query);
                        ;?>
                    <p style="margin-left: 50px;">Tổng số nhân viên: <?php echo $dem ;?> </p>
                </div>
                <div>
                    <table style="margin-left: 100px;">
                        <tr>
                            <td style="font-weight: bold; text-align: center;">STT</td>
                            <td style="font-weight: bold; text-align: center;">Id nhân viên</td>
                            <td style="font-weight: bold; text-align: center;">Họ tên</td>
                            <td style="font-weight: bold; text-align: center;">Tên đăng nhập</td>
                            <td style="font-weight: bold; text-align: center;">Công việc</td>
                            <td style="font-weight: bold; text-align: center;">Facebook</td>
                            <td style="font-weight: bold; text-align: center;">Instagram</td>
                        </tr>

                        <?php
                            $sql="SELECT * from tbl_admin as tbl1 join tbl_nhan_vien as tbl2
                            on tbl1.id_nhan_vien=tbl2.id_nhan_vien";
                            $noi_dung_tin_tuc=mysqli_query($ket_noi,$sql);
                            $i=0;
                            while ($row=mysqli_fetch_array($noi_dung_tin_tuc)) { $i++;
                        ;?>
                            <tr>
                                <td><?php echo $i ;?></td>

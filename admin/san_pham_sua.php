...
<body>
    ...
    <!-- Header Section End -->
     ...
     <section class="login spad">
        <div class="row">
                <div >
                    <p style="font-style: italic; font-weight: bold; font-family: Playfair Display; font-size: 20px; margin-top:-50px; margin-left: 50px;">Sửa sản phẩm: </p>
                </div>
                <div>
                    <form method="POST" action="./san_pham_sua_thuc_hien.php" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div>
                                <p>
                                    Tên sản phẩm:<br>
                                    <input type="text" name="txtTenSP" style="width: 100%" value="<?php echo $row["ten_san_pham"];?>">
                                </p>
                                <p>
                                    Tên loại sản phẩm: <br>
                                    <select name="txtLoaiSP" id="">
                                        <option>Chọn</option>
                                        <option value="L01">Cupcake</option>
                                        <option value="L02">Crepe</option>
                                        <option value="L03">Cheesecake</option>
                                        <option value="L04">Donut</option>
                                        <option value="L05">Loại khác</option>
                            ...
                            <div style="margin-left: 50px;">
                                <p>
                                    Mô tả: <br>
                                    <textarea name="txtMoTa" style="width: 200%;"><?php echo $row["mo_ta"] ;?></textarea>
                                </p>
                                <p>
                                    Giá bán: <br>
                                    <input type="text" name="txtGiaBan" style="width: 100%" value="<?php echo $row["gia_ban"];?>">
                                </p>
                                <p>
                                    Số lượng tồn kho:<br>
                                    <input type="text" name="txtSLTonKho" style="width: 100%" value="<?php echo $row["so_luong_ton_kho"];?>">
                                </p>

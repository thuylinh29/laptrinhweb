                ...
                <div class="col-lg-12">
                    <nav class="header__menu mobile-menu">
                        <ul>
                            ...
                            <li  class="active"><a href="danh_gia.php">Đánh giá</a></li>
        ...
        <div class="row">
                <div >
                    <p style="font-style: italic; font-weight: bold; font-family: Playfair Display; font-size: 20px; margin-top:-50px; margin-left: 50px;">Thông tin khách hàng: </p>
                        <?php 
                            $ket_noi=mysqli_connect("localhost","root","","cua_hang_banh");
                            $count="SELECT * from tbl_danh_gia";
                            $query=mysqli_query($ket_noi,$count);
                            $dem=mysqli_num_rows($query);
                        ;?>
                    <p style="margin-left: 50px;">Tổng số đánh giá: <?php echo $dem ;?> </p>
                </div>
                <div>
                    <table style="margin-left: 100px;">
                        <tr>
                            ...
                            <td style="font-weight: bold; text-align: center;">Tỉnh</td>
                            <td style="font-weight: bold; text-align: center;">Tên sản phẩm</td>
                            <td style="font-weight: bold; text-align: center;">Nội dung</td>
                            <td style="font-weight: bold; text-align: center;">Số sao</td>
                        </tr>

                        <?php
                            $sql="SELECT * from tbl_danh_gia ";
                            $noi_dung_danh_gia=mysqli_query($ket_noi,$sql);
                            $i=0;
                            while ($row=mysqli_fetch_array($noi_dung_danh_gia)) { $i++;
                        ;?>
                            <tr>
                                <td><?php echo $i ;?></td>
                                ...
                                <td style="width: 200px"><?php echo $row["noi_dung"] ;?></td>

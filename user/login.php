            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="login_style"> 
                        <form method="post" action="logged.php" autocomplete="on">
                            <table width="535" height="200" cellpadding="10">
                                ...
                                <tr>
                                    <th colspan="2"><a href="../admin/admin_login.php">Admin</a></th>
                                    <th style="width:25%"><a href="./dang_ky.php">Đăng kí</a></th>
                                </tr>
                            </table>
                        </form>
                    </div>

                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <?php
                            if (isset($_REQUEST['ok'])) 
                            {
                                ...
                                if (empty($search)) 
                                {
                                    echo "Bạn hãy nhập từ khóa!";
                                } 
                                else
                                {
                                    $query = "SELECT * from tbl_san_pham as tbl1 join tbl_loai_san_pham as tbl2
                                        on tbl1.id_loai_san_pham=tbl2.id_loai_san_pham 
                                        where ten_loai_san_pham like '%$search%'";
                    ...
                    <div class="product__item">
                        ...
                        <div class="product__item__text">
                            ...
                            <div class="product__item__price"><?php echo number_format($row["gia_ban"],0,",",".") ;?></div>
                            <div class="cart_add">
